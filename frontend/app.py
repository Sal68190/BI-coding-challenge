...
def query_backend(query: str) -> Dict[str, Any]:
    """Send query to backend with caching"""
    try:
...
def calculate_metrics(history_length: int):
    """Calculate dashboard metrics with caching"""
    ...
    return {
        ...
        "unique_docs": len(document_frequencies),
